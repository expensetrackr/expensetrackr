...
var ys = (i) => i === 0 || i === 1,
    ...
    Ie = {
        ...
        easeInOutElastic(i) {
            return ys(i) ? i : i < 0.5 ? 0.5 * bo(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * xo(i * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(i) {
...
var jc = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function $o(i, t, e) {
...
function Rn(i) {
    ...
    return (
        r !== o &&
            ((h = r - o), (c = a > 0.5 ? h / (2 - r - o) : h / (r + o)), (l = Zc(e, s, n, h, r)), (l = l * 60 + 0.5)),
        [l | 0, c || 0, a]
    );
}
function Wn(i, t, e, s) {
...
var eh = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
function ih(i) {
    let t = eh.exec(i),
        e = 255,
        s,
...
function qo(i, t, e, s) {
    ...
    for (l = 0; l < a; l++)
        ...
        else if (B(u)) for (c = 0, h = u.length; c < h; c++) (d = u[c]), d != null && !B(d) && (o = bi(i, n, r, o, d));
    i.restore();
    let f = r.length / 2;
    if (f > e.length) {
...
var fh = (i, t) => (i ? i + vs(t) : t),
    Un = (i, t) => F(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Jo(i, t, e) {
...
function ia(i, t, e, s, n) {
    let r, o, a, l;
    if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone")) vh(i, n);
    else {
        ...
        (b = t[v % o]),
            !b.skip &&
                ...
                y !== _ &&
                    ...
                    p !== null && k() && (m.push(Oo({ start: p, end: v, loop: d, count: o, style: f })), (p = null)),
                    (T = v),
                    (_ = y)));
...
A.set("animations", { colors: { type: "color", properties: $h }, numbers: { type: "number", properties: Bh } });
...
function ma(i, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        (d = y[c] = Jh(n, h, g)), (d[a] = p), (d._top = fa(d, o, !0, s.type)), (d._bottom = fa(d, o, !1, s.type));
    }
}
function er(i, t) {
    let e = i.scales;
...
function cu(i, t, e, s) {
    ...
    n === "middle" &&
        ...
        (e._top || 0) === s ? (n = c) : (e._bottom || 0) === s ? (n = h) : ((r[ya(h, o, a, l)] = !0), (n = c))),
        (r[ya(n, o, a, l)] = !0),
        (i.borderSkipped = r);
}
function ya(i, t, e, s) {
...
var be = class i extends pt {
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                let e = this.options.ticks.sampleSize,
                    s = this.ticks;
                e < s.length && (s = _a(s, e)), (this._labelSizes = t = this._computeLabelSizes(s, s.length));
            }
            return t;
        }
        ...
        _computeLabelItems(t) {
            ...
            for (y = 0, b = a.length; y < b; ++y) {
                ...
                if (D.showLabelBackdrop) {
                    ...
                    ps = { left: yn, top: pn, width: gn + De.width, height: mi + De.height, color: D.backdropColor };
                }
                p.push({
                    rotation: g,
                    label: w,
    ...
    He = class {
        ...
        register(t) {
            ...
            return r in n || ((n[r] = t), Ou(t, o, s), this.override && A.override(t.id, t.overrides)), o;
        }
        get(t) {
            return this.items[t];
        }
...
function Ou(i, t, e) {
    ...
    A.set(t, s), i.defaultRoutes && Du(t, i.defaultRoutes), i.descriptors && A.describe(t, i.descriptors);
}
function Du(i, t) {
...
function Ea(i, t, e) {
    ...
    return (
        r ||
            ((r = { resolver: As(t, e), subPrefixes: e.filter((a) => !a.toLowerCase().includes("hover")) }),
            s.set(n, r)),
        r
    );
}
            ...
            e &&
                ...
                V(r, (o) => {
                    let a = o.options,
                        ...
                        c = yr(l, a),
                        h = E(a.type, o.dtype);
                    (a.position === void 0 || Ia(a.position, c) !== Ia(o.dposition)) && (a.position = o.dposition),
                        (n[l] = !0);
                    let u = null;
...
function _d(i, t, e) {
    let { x: s, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
        ...
        c = t.innerRadius + o,
        h;
    for (e && dl(i, t, r + H), i.beginPath(), i.arc(s, n, c, r + H, r, !0), h = 0; h < a; ++h) i.stroke();
...
function Od(i, t, e, s) {
    let n = t._path;
    n || ((n = t._path = new Path2D()), t.path(n, e, s) && n.closePath()), fl(i, t.options), i.stroke(n);
}
function Dd(i, t, e, s) {
    let { segments: n, options: r } = t,
        o = _r(t);
    for (let a of n)
        fl(i, r, a.style), i.beginPath(), o(i, t, a, { start: e, end: e + s - 1 }) && i.closePath(), i.stroke();
}
...
var Xe = class extends pt {
    ...
    draw(t) {
        ...
        t.save(),
            (o.w !== r.w || o.h !== r.h) &&
                (t.beginPath(), a(t, lr(o, e, r)), t.clip(), a(t, lr(r, -e, o)), (t.fillStyle = s), t.fill("evenodd")),
            t.beginPath(),
            a(t, lr(r, e)),
            (t.fillStyle = n),
            t.fill(),
...
var Nd = Object.freeze({ __proto__: null, ArcElement: qe, LineElement: Nt, PointElement: Ge, BarElement: Xe });
...
function cr(i, t, e) {
    ...
    s &&
        n.points.length &&
        (wi(i, e), rf(i, { line: n, target: s, above: h, below: u, area: e, scale: r, axis: o }), Si(i));
}
function rf(i, t) {
...
var af = {
        ...
        afterDatasetsUpdate(i, t, e) {
            ...
            for (o = 0; o < s; ++o)
                (r = i.getDatasetMeta(o)),
                    ...
                    (r.$filler = l),
                    n.push(l);
            for (o = 0; o < s; ++o) (l = n[o]), !(!l || l.fill === !1) && (l.fill = $d(n, o, e.propagate));
        },
        beforeDraw(i, t, e) {
    ...
    lf = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index,
    qs = class extends pt {
        constructor(t) {
            super(),
                (this._added = !1),
...
var Tf = (i, t) => (i === null ? null : tt(Math.round(i), 0, t)),
    Ke = class extends be {
        ...
        parse(t, e) {
            if (P(t)) return null;
            let s = this.getLabels();
            return (e = isFinite(e) && s[e] === t ? e : Mf(s, t, E(e, t), this._addedLabels)), Tf(e, s.length - 1);
        }
        determineDataLimits() {
...
function vf(i, t) {
    ...
    for (
        y &&
        (d && k !== o
            ? (e.push({ value: o }), k < o && N++, Pe(Math.round((k + N * x) * S) / S, o, Za(o, w, i)) && N++)
            : k < o && N++);
        N < T;
        ++N
    )
...
function Ef(i) {
    ...
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (i._pointLabelItems = Cf(i, s, n));
}
...
var Nr = class {
    ...
    Wr = class {
        ...
        format(t, e) {
            return this.rtf ? this.rtf.format(t, e) : kl(e, t, this.opts.numeric, this.opts.style !== "long");
        }
        formatToParts(t, e) {
    ...
    W = class i {
        ...
        get fastNumbers() {
            return this.fastNumbersCached == null && (this.fastNumbersCached = im(this)), this.fastNumbersCached;
        }
        listingMode() {
        ...
        months(t, e = !1) {
            return sn(this, t, zr, () => {
                ...
                return (
                    this.monthsCache[n][t] || (this.monthsCache[n][t] = tm((r) => this.extract(r, s, "month"))),
        ...
        weekdays(t, e = !1) {
            return sn(this, t, Vr, () => {
                let s = e ? { weekday: t, year: "numeric", month: "long", day: "numeric" } : { weekday: t },
                    n = e ? "format" : "standalone";
                return (
                    this.weekdaysCache[n][t] || (this.weekdaysCache[n][t] = em((r) => this.extract(r, s, "weekday"))),
    ...
    st = class i {
        ...
        formatDateTimeFromString(t, e) {
            let s = this.loc.listingMode() === "en",
                ...
                c = (f, m) =>
                    s ? Zl(t, f) : r(m ? { weekday: f } : { weekday: f, month: "long", day: "numeric" }, "weekday"),
                h = (f) => {
...
function ci(i, t) {
    return [
        { hours: ri(i, t, 0), minutes: ri(i, t + 1, 0), seconds: ri(i, t + 2, 0), milliseconds: cs(i[t + 3]) },
        null,
        t + 4,
    ];
}
...
function ro(i, t, e, s, n, r, o) {
    ...
    return o && (a.second = Ut(o)), i && (a.weekday = i.length > 3 ? eo.indexOf(i) + 1 : io.indexOf(i) + 1), a;
}
var Tm =
...
function It(i, t) {
    return i === null
        ? null
        : { regex: RegExp(i.map(Km).join("|")), deser: ([e]) => i.findIndex((s) => pc(e) === pc(s)) + t };
}
function yc(i, t) {
...
function fo(i) {
    return (
        i.localWeekData === null && (i.localWeekData = os(i.c, i.loc.getMinDaysInFirstWeek(), i.loc.getStartOfWeek())),
        i.localWeekData
    );
}
function ve(i, t) {
    ...
    I = class i {
        constructor(t) {
            let e = t.zone || R.defaultZone,
                s = t.invalid || (Number.isNaN(t.ts) ? new it("invalid input") : null) || (e.isValid ? null : ms(e));
        ...
        static fromObject(t, e = {}) {
            ...
            let g = m || (r.weekday && !f),
                ...
                y,
                b = hn(l, c);
            g ? ((p = cg), (y = ag), (b = os(b, o, a))) : h ? ((p = hg), (y = lg), (b = ln(b))) : ((p = Ic), (y = Ec));
            let _ = !1;
            for (let C of p) {
                let N = r[C];
        ...
        set(t) {
            ...
            r
                ...
                : O(e.ordinal)
                  ? ((u = { ...this.toObject(), ...e }), O(e.day) && (u.day = Math.min(si(u.year, u.month), u.day)))
                  : (u = qr({ ...ln(this.c), ...e }));
        ...
        toFormat(t, e = {}) {
            return this.isValid ? st.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t) : ho;
        }
        toLocaleString(t = re, e = {}) {
