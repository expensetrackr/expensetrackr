...
`
        ...
        function Uc(e, t) {
            return function (n, r, i, a, l, u, f) {
                ...
                for (var m = n.pos, A = m + r.length; ; ) {
                    for (var j = void 0, ee = 0; ee < t.length && ((j = t[ee]), !(j.to > m && j.from <= m)); ee++);
                    if (j.to >= A) return e(n, r, i, a, l, u, f);
                    e(n, r.slice(0, j.to - m), i, a, null, u, f), (a = null), (r = r.slice(j.to - m)), (m = j.to);
                }
            };
        }
        function Ea(e, t, n, r) {
        ...
        function Vr(e) {
            ...
            if (zr == null) {
                ...
                for (var t = 0; t < 49; ++t) zr.appendChild(document.createTextNode("x")), zr.appendChild(x("br"));
        ...
        function pf(e, t, n, r) {
            ...
            for (var a = 0; a < 5; a++) {
                ...
                if (
                    ...
                    m.scrollLeft != null && (Dr(e, m.scrollLeft), Math.abs(e.doc.scrollLeft - j) > 1 && (l = !0)),
                    !l)
                )
                    break;
            }
                ...
                if (!j.hidden)
                    if (!j.node || j.node.parentNode != a) {
                        ...
                        j.changes && (Se(j.changes, "gutter") > -1 && (Y = !1), Ma(e, j, m, n)),
                            Y && (R(j.lineNumber), j.lineNumber.appendChild(document.createTextNode(he(e.options, m)))),
        ...
        function Ef(e, t, n, r) {
            ...
            (i.mover = x("div", [a], null, "position: relative")),
                ...
                (i.sizerWidth = null),
                (i.heightForcer = x("div", null, null, "position: absolute; height: " + je + "px; width: 1px;")),
        ...
        function Pf(e, t, n) {
            ...
            if (j || A) {
                ...
                j && ht(e, "change", e, ee), A && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(ee);
            }
            ...
            if (
                (e.iter(u, n.line + 1, function (j) {
                    f && a.collapsed && !f.options.lineWrapping && Zt(j) == f.display.maxLine && (m = !0),
                        ...
                        Mc(j, new ni(a, u == t.line ? t.ch : null, u == n.line ? n.ch : null), e.cm && e.cm.curOp),
                        ++u;
                }),
                a.collapsed &&
...
`,
        ...
        function Gl(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = H(de(t))), !ot(t, e))) {
                ...
                d &&
                    ((Ho = r ? n : null),
                    !r && n == 88 && !ti && (N ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                    v &&
                        !N &&
                        !r &&
                        n == 46 &&
        ...
        function vd(e) {
            ...
            (e.prototype = {
                ...
                lineAtHeight: function (r, i) {
                    return (
                        (r = Ua(this, { top: r, left: 0 }, i || "page").top), P(this.doc, r + this.display.viewOffset)
                    );
                },
                ...
                findPosV: function (r, i, a, l) {
                    ...
                    for (var m = Re(this.doc, r), A = 0; A < i; ++A) {
                        var j = Xt(this, m, "div");
                        if ((f == null ? (f = j.left) : (j.left = f), (m = as(this, j, u, a)), m.hitSide)) break;
                    }
                    return m;
                },
                moveV: Tt(function (r, i) {
                    ...
                    if (
                        (l.extendSelectionsBy(function (A) {
                            ...
                            var ee = as(a, j, r, i);
                            return i == "page" && A == l.sel.primary() && Lo(a, fi(a, ee, "div").top - j.top), ee;
                        }, He),
                        u.length)
                    )
...
`));
            ...
            (Qe.prototype.pollContent = function () {
                ...
                for (
                    var _e = ce(j),
                        be = ce(ee),
                        Ce = Math.min(_e.length - (j.length == 1 ? Y : 0), be.length - (ee.length == 1 ? Y : 0));
...
var ys = Ke((vs, bs) => {
    (function (o) {
        ...
        function T(y) {
            ...
            S(d, M.to) > 0 && (d.line - M.from.line < C ? (k.pop().clear(), s(y, M.from, d)) : s(y, M.to, d));
        }
    });
});
var ks = Ke((xs, _s) => {
    (function (o) {
        ...
        function C(w, W) {
            for (var E = v(w), N = E, G = 0; G < W.length; G++) N.indexOf(W.charAt(G)) == -1 && (N += W.charAt(G));
        ...
        function S(w, W, E) {
            W = C(W, "g");
            for (var N = E.line, G = E.ch, J = w.lastLine(); N <= J; N++, G = 0) {
                W.lastIndex = G;
                var re = w.getLine(N),
                    q = W.exec(re);
...
`),
        ...
        function g(w, W, E) {
            W = C(W, "g");
            for (var N = E.line, G = E.ch, J = w.firstLine(); N >= J; N--, G = -1) {
                var re = w.getLine(N),
        ...
        function T(w, W, E) {
            ...
            W = C(W, "gm");
            for (var N, G = 1, J = w.getLine(E.line).length - E.ch, re = E.line, q = w.firstLine(); re >= q; ) {
...
`),
        ...
        function k(w, W, E, N) {
            ...
            var G = N ? y : c,
                J = G(W).split(/\r|\n\r?/);
            e: for (var re = E.line, q = E.ch, O = w.lastLine() + 1 - J.length; re <= O; re++, q = 0) {
                ...
                if (J.length == 1) {
                    ...
                    return { from: p(re, d(D, Q, V, G) + q), to: p(re + J.length - 1, d(K, X, I.length, G)) };
                }
            }
        }
        function z(w, W, E, N) {
            ...
            var G = N ? y : c,
                J = G(W).split(/\r|\n\r?/);
            e: for (var re = E.line, q = E.ch, O = w.firstLine() - 1 + J.length; re >= O; re--, q = -1) {
                var D = w.getLine(re);
                q > -1 && (D = D.slice(0, q));
                var Q = G(D);
                if (J.length == 1) {
...
var Vo = Ke((ws, Ss) => {
    (function (o) {
        ...
        function v(I, H, le, xe) {
            var F = I.indented;
            return (
                I.context && I.context.type == "statement" && le != "statement" && (F = I.context.indented),
                (I.context = new p(F, H, le, xe, null, I.context))
            );
        }
        function C(I) {
            var H = I.context.type;
            return (
                (H == ")" || H == "]" || H == "}") && (I.indented = I.context.indented), (I.context = I.context.prev)
            );
        }
        function b(I, H, le) {
            if (
        ...
        o.defineMode("clike", function (I, H) {
            ...
            function Ue(we, Me) {
                H.typeFirstDefinitions && we.eol() && S(Me.context) && (Me.typeAtEndOfLine = b(we, Me, we.pos));
            }
            return {
                ...
                indent: function (we, Me) {
                    ...
                    return Le.type == "statement"
                        ...
                        : Le.align && (!F || Le.type != ")")
                          ...
                          : Le.type == ")" && !B
                            ? Le.indented + xe
                            : Le.indented + (B ? 0 : le) + (!B && De && !/^(?:case|default)\b/.test(Me) ? le : 0);
                },
        ...
        function s(I) {
            for (var H = {}, le = I.split(" "), xe = 0; xe < le.length; ++xe) H[le[xe]] = !0;
            return H;
        }
        function h(I, H) {
        ...
        function re(I, H) {
            if ((I.backUp(1), I.match(/^(?:R|u8R|uR|UR|LR)/))) {
                ...
                return le ? ((H.cpp11RawStringDelim = le[1]), (H.tokenize = D), D(I, H)) : !1;
            }
        ...
        function Q(I, H) {
            ...
            xe(H.keywords),
                ...
                xe(H.builtin),
                xe(H.atoms),
                le.length && ((H.helperType = I[0]), o.registerHelper("hintWords", I[0], le));
            for (var F = 0; F < I.length; ++F) o.defineMIME(I[F], H);
        }
        Q(["text/x-csrc", "text/x-c", "text/x-chdr"], {
            ...
            Q("text/x-java", {
                ...
                hooks: {
                    ...
                    '"': function (I, H) {
                        return I.match(/""$/) ? ((H.tokenize = R), H.tokenize(I, H)) : !1;
                    },
                },
            ...
            Q("text/x-csharp", {
                ...
                hooks: {
                    "@": function (I, H) {
                        return I.eat('"') ? ((H.tokenize = O), O(I, H)) : (I.eatWhile(/[\w\$_]/), "meta");
                    },
                },
            });
        function R(I, H) {
                ...
                for (var xe; (xe = H.next()); )
                    if (xe == "*" && H.eat("/"))
                        if (I == 1) {
                            le.tokenize = null;
                            break;
                        } else return (le.tokenize = V(I - 1)), le.tokenize(H, le);
                    else if (xe == "/" && H.eat("*")) return (le.tokenize = V(I + 1)), le.tokenize(H, le);
                return "comment";
            };
        }
        Q("text/x-scala", {
            ...
            hooks: {
                ...
                "=": function (I, H) {
                    ...
                    return le.type == "}" && le.align && I.eat(">")
                        ? ((H.context = new p(le.indented, le.column, le.type, le.info, null, le.prev)), "operator")
                        : !1;
                },
                "/": function (I, H) {
                    return I.eat("*") ? ((H.tokenize = V(1)), H.tokenize(I, H)) : !1;
                },
            },
        ...
        function x(I) {
            return function (H, le) {
                for (var xe = !1, F, L = !1; !H.eol(); ) {
                    ...
                    (F = H.next()), !xe && F == "$" && H.match("{") && H.skipTo("}"), (xe = !xe && F == "\\" && !I);
                }
        ...
        Q("text/x-kotlin", {
            ...
            hooks: {
                ...
                indent: function (I, H, le, xe) {
                    ...
                    if (H.align && H.type == "}") return H.indented + (I.context.type == (le || "").charAt(0) ? 0 : xe);
                },
            },
        ...
        function X(I) {
            return function (H, le) {
                for (var xe = !1, F, L = !1; !H.eol(); ) {
                    if (!xe && H.match('"') && (I == "single" || H.match('""'))) {
                        L = !0;
                        break;
                    }
                    if (!xe && H.match("``")) {
        ...
        Q("text/x-ceylon", {
            ...
            hooks: {
                ...
                '"': function (I, H) {
                    return (H.tokenize = X(I.match('""') ? "triple" : "single")), H.tokenize(I, H);
                },
                "`": function (I, H) {
                    return !K || !I.match("`") ? !1 : ((H.tokenize = K), (K = null), H.tokenize(I, H));
                },
                "'": function (I) {
        ...
        o.defineMode("css", function (O, D) {
            ...
            return (
                ...
                (Be.atBlock_parens = function (te, fe, oe) {
                    return te == ")" ? Ge(oe) : te == "{" || te == "}" ? Z(te, fe, oe, 2) : Be.atBlock(te, fe, oe);
                }),
            ...
            o.defineMIME("text/x-scss", {
                ...
                tokenHooks: {
                    ...
                    $: function (O) {
                        return (
                            O.match(/^[\w-]+/),
                            O.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"]
                        );
                    },
                    "#": function (O) {
        ...
        o.defineMode("xml", function (C, b) {
            ...
            function M(x) {
                return function (K, X) {
                    for (var I; (I = K.next()) != null; ) {
                        if (I == "<") return (X.tokenize = M(x + 1)), X.tokenize(K, X);
                        if (I == ">")
                            if (x == 1) {
                                X.tokenize = c;
                                break;
            ...
            function N(x, K) {
                for (var X; ; ) {
                    if (
                        !x.context ||
                        ((X = x.context.tagName),
                        !s.contextGrabbers.hasOwnProperty(w(X)) || !s.contextGrabbers[w(X)].hasOwnProperty(w(K)))
                    )
                        return;
                    E(x);
                }
            ...
            function D(x, K, X) {
                ...
                if (x == "endTag" || x == "selfcloseTag") {
                    ...
                    return (
                        ...
                        x == "selfcloseTag" || s.autoSelfClosers.hasOwnProperty(w(I))
                            ? N(X, I)
                            : (N(X, I), (X.context = new W(X, I, H == X.indented))),
                        G
                    );
                }
                return (y = "error"), D;
            ...
            return {
                startState: function (x) {
                    var K = { tokenize: c, state: G, indented: x || 0, tagName: null, tagStart: null, context: null };
                ...
                token: function (x, K) {
                    ...
                    return (
                        (X || T) &&
                            X != "comment" &&
                            ((y = null), (K.state = K.state(T || X, x, K)), y && (X = y == "error" ? X + " error" : y)),
                        X
                    );
                },
                    ...
                    if (H && H[1])
                        for (; I; )
                            if (I.tagName == H[2]) {
                                I = I.prev;
                                break;
                            } else if (s.implicitlyClosed.hasOwnProperty(w(I.tagName))) I = I.prev;
                            else break;
                    else if (H)
                        for (; I; ) {
                            var le = s.contextGrabbers[w(I.tagName)];
    ...
    (function (o) {
        ...
        o.defineMode("javascript", function (p, v) {
            ...
            function W(_, P) {
                ...
                if (/\d/.test(ae))
                    return _.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), w("number", "number");
                if (ae == "/")
                    return _.eat("*")
                        ? ((P.tokenize = N), N(_, P))
                        : _.eat("/")
            ...
            function E(_) {
                return function (P, ae) {
                    var he = !1,
                        ne;
                    if (S && P.peek() == "@" && P.match(d)) return (ae.tokenize = W), w("jsonld-keyword", "meta");
            ...
            function L() {
                (R.state.context = new le(R.state.context, R.state.localVars, !1)), (R.state.localVars = F);
            }
            function de() {
                (R.state.context = new le(R.state.context, R.state.localVars, !0)), (R.state.localVars = null);
            }
            L.lex = de.lex = !0;
            function ze() {
            ...
            function pe(_, P) {
                var ae = function () {
                    ...
                    he.lexical = new O(ne, R.stream.column(), _, null, he.lexical, P);
                };
                return (ae.lex = !0), ae;
            }
            function Ee() {
                var _ = R.state;
                _.lexical.prev &&
                    (_.lexical.type == ")" && (_.indented = _.lexical.indented), (_.lexical = _.lexical.prev));
            }
            Ee.lex = !0;
            function ge(_) {
                function P(ae) {
                                  ...
                                  : _ == "function"
                                    ...
                                    : _ == "for"
                                      ...
                                      : _ == "class" || (g && P == "interface")
                                        ? ((R.marked = "keyword"), x(pe("form", _ == "class" ? _ : P), Wr, Ee))
                                        : _ == "variable"
                                          ? g && P == "declare"
                                              ...
                                              : g &&
                                                ...
                                                : g && P == "namespace"
                                                  ...
                                                  : g && P == "abstract"
                                                    ...
                                                    : x(pe("stat"), Ue)
                                          : _ == "switch"
                                            ? x(pe("form"), Ze, ge("{"), pe("}", "switch"), de, De, Ee, Ee, ze)
                                            : _ == "case"
                                              ? x(Se, ge(":"))
                                              : _ == "default"
                                                ? x(ge(":"))
            ...
            function te(_) {
                return function (P) {
                    return P == "." ? x(_ ? oe : fe) : P == "variable" && g ? x(It, _ ? Ge : He) : V(_ ? je : Se);
                };
            }
            function fe(_, P) {
            ...
            function Kr(_, P) {
                return _ == "{" ? se(Kr, "}") : (_ == "variable" && X(P), P == "*" && (R.marked = "keyword"), x(_n));
            }
            function Vt(_) {
                if (_ == ",") return x(Kr, Vt);
            }
            ...
            return {
                ...
                indent: function (_, P) {
                    ...
                    for (
                        ...
                        (ae == "}" ||
                            ((ne = _.cc[_.cc.length - 1]) && (ne == He || ne == Ge) && !/^[,\.=+\-*:?[\(]/.test(P)));
...
var Qn = Ke((Os, Ps) => {
    (function (o) {
        ...
        function h(T, y) {
            for (var c in T) for (var d = y[c] || (y[c] = []), k = T[c], z = k.length - 1; z >= 0; z--) d.unshift(k[z]);
        }
        function g(T, y) {
        ...
        o.defineMode(
            ...
            function (T, y) {
                var c = o.getMode(T, {
                    ...
                    z = y && y.scriptTypes;
                if ((h(p, d), k && h(k, d), z))
                    for (var M = z.length - 1; M >= 0; M--) d.script.unshift(["type", z[M].matches, z[M].mode]);
                function w(W, E) {
...
var Di = Ke((Bs, Ws) => {
    (function (o) {
                ...
                if (k.local)
                    if (k.local.end && d.match(k.local.end)) {
                        ...
                        var M = k.local.mode.token(d, k.localState),
                            w;
                        return (
                            k.local.endScan && (w = k.local.endScan.exec(d.current())) && (d.pos = d.start + w.index), M
                        );
                    }
        ...
        function h(y, c, d, k) {
            ...
            d.persistent && !z && (c.persistentStates = { mode: w, spec: d.spec, state: W, next: c.persistentStates }),
                (c.localState = W),
                (c.local = {
                    mode: w,
                    end: d.end && v(d.end),
                ...
                e: for (;;) {
                    for (var W = 0; W < w.length; W++) {
                        ...
                        if (E.data.dedent && E.data.dedentIfLineStart !== !1) {
                            ...
                            if (N && N[0]) {
                                M--, (E.next || E.push) && (w = y[E.next || E.push]), (k = k.slice(N[0].length));
                                continue e;
                            }
                        }
                    }
        ...
        o.defineMode(
            ...
            function (p, v) {
                ...
                function D(F) {
                    var L = [];
                    if (F.formatting) {
                        L.push(s.formatting), typeof F.formatting == "string" && (F.formatting = [F.formatting]);
                ...
                function R(F, L) {
                    ...
                    if (pe === "]" && L.linkText) {
                        ...
                        var je = D(L);
                        return (L.linkText = !1), (L.inline = L.f = F.match(/\(.*?\)| ?\[.*?\]/, !1) ? x : R), je;
                    }
                    ...
                    if (
                        ...
                        return F.backUp(1), (L.htmlState = o.startState(C)), N(F, L, q);
                    }
                    if (v.xml && pe === "<" && F.match(/^\/\w*?>/)) return (L.md_inside = !1), "tag";
                    if (pe === "*" || pe === "_") {
                        for (var He = 1, Ge = F.pos == 1 ? " " : F.string.charAt(F.pos - 2); He < 3 && F.eat(pe); )
                            He++;
                        var U = F.peek() || " ",
                    ...
                    if (v.emoji && pe === ":" && F.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
    ...
    (function (o) {
        ...
        o.defineMode("go", function (p) {
            ...
            function y(k, z, M, w, W) {
                (this.indented = k), (this.column = z), (this.type = M), (this.align = w), (this.prev = W);
            }
            function c(k, z, M) {
            ...
            return {
                startState: function (k) {
                    return { tokenize: null, context: new y((k || 0) - v, 0, "top", !1), indented: 0, startOfLine: !0 };
                },
                token: function (k, z) {
                    var M = z.context;
                    if (
            ...
            return {
                ...
                token: function (k, z) {
                    ...
                    return (
                        h == "hash" && w == "rule"
                            ? (M = "atom")
                            : M == "variable" && (w == "rule" ? (M = "number") : (!w || w == "@media{") && (M = "tag")),
...
var Su = Ke((ku, wu) => {
    (function (o) {
        ...
        function b(T, y, c, d) {
            if ((d !== !1 && T.match("${", !1)) || T.match("{$", !1)) return (y.tokenize = null), "string";
            ...
            for (
                var k = !1;
                !T.eol() && (k || d === !1 || (!T.match("{$", !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1)));
            ...
            hooks: {
                ...
                "<": function (T, y) {
                    ...
                    if ((c = T.match(/^<<\s*/))) {
                        ...
                        if ((d && T.eat(d), k))
                            return (
                                (y.tokStack || (y.tokStack = [])).push(k, 0), (y.tokenize = C(k, d != "'")), "string"
                            );
                    }
                    return !1;
                },
        ...
        o.defineMode(
            ...
            function (T, y) {
                ...
                function k(z, M) {
                    var w = M.curMode == d;
                    if ((z.sol() && M.pending && M.pending != '"' && M.pending != "'" && (M.pending = null), w))
                ...
                return {
                    ...
                    copyState: function (z) {
                        ...
                        return (
                            z.curMode == c ? (N = w) : (N = E),
                            { html: w, php: E, curMode: z.curMode, curState: N, pending: z.pending }
                        );
                    },
                    token: k,
        ...
        o.defineMode("python", function (h, g) {
            ...
            function J(K, X) {
                ...
                if ((I && (X.indent = K.indentation()), I && S(X).type == "py")) {
                    ...
                    if (K.eatSpace()) {
                        ...
                        return le > H ? D(X) : le < H && R(K, X) && K.peek() != "#" && (X.errorToken = !0), null;
                    } else {
                        var xe = re(K, X);
                ...
                function xe(F, L) {
                    for (; !F.eol(); )
                        if ((F.eatWhile(/[^'"\{\}\\]/), F.eat("\\"))) {
                            ...
                            if (F.match("{{")) return H;
                            if (F.match("{", !1)) return (L.tokenize = le(0)), F.current() ? H : L.tokenize(F, L);
                            if (F.match("}}")) return H;
                            if (F.match("}")) return T;
                            F.eat(/['"]/);
                        }
            ...
            var x = {
                ...
                token: function (K, X) {
                    ...
                    var H = V(K, X);
                    return (
                        H && H != "comment" && (X.lastToken = H == "keyword" || H == "punctuation" ? K.current() : H),
                ...
                indent: function (K, X) {
                    ...
                    return I.align != null ? I.align - (H ? 1 : 0) : I.offset - (H ? k : 0);
                },
    ...
    (function (o) {
        ...
        o.defineMode("ruby", function (g) {
            ...
            function c(E, N) {
                ...
                var G = E.next(),
                    J;
                if (G == "`" || G == "'" || G == '"') return y(M(G, "string", G == '"' || G == "`"), E, N);
                if (G == "/") return d(E) ? y(M(G, "string-2", !0), E, N) : "operator";
                if (G == "%") {
                    var re = "string",
                        q = !0;
                    E.eat("s")
                    ...
                    var O = E.eat(/[^\w\s=]/);
                    return O ? (s.propertyIsEnumerable(O) && (O = s[O]), y(M(O, re, q, !0), E, N)) : "operator";
                } else {
            ...
            return {
                ...
                indent: function (E, N) {
                    ...
                    var G = N && N.charAt(0),
                        ...
                        re =
                            J.type == h[G] ||
                            (J.type == "keyword" && /^(?:end|until|else|elsif|when|rescue)\b/.test(N));
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function w(q, O) {
                    return function (D, Q) {
                        return D.sol() && D.indentation() <= q
                            ? ((Q.tokenizer = J), J(D, Q))
                            : (O && D.skipTo("*/") ? (D.next(), D.next(), (Q.tokenizer = J)) : D.skipToEnd(),
                              "comment");
                    };
                }
                function W(q, O) {
                    ...
                    function D(Q, R) {
                        var V = Q.next(),
                            ...
                            X = (V !== "\\" && x === q) || (V === q && K !== "\\");
                        return X
                            ? (V !== q && O && Q.next(), z(Q) && (R.cursorHalf = 0), (R.tokenizer = J), "string")
                            : V === "#" && x === "{"
                ...
                function J(q, O) {
                    var D = q.peek();
                    if (q.match("/*")) return (O.tokenizer = w(q.indentation(), !0)), O.tokenizer(q, O);
                    if (q.match("//")) return (O.tokenizer = w(q.indentation(), !1)), O.tokenizer(q, O);
                ...
                function re(q, O) {
                    ...
                    if (((Q === "@return" || Q === "}") && G(O), D !== null)) {
                        for (
                            var R = q.pos - Q.length, V = R + p.indentUnit * O.indentCount, x = [], K = 0;
                            K < O.scopes.length;
                            K++
                        ) {
                            var X = O.scopes[K];
    ...
    (function (o) {
        ...
        o.defineMode("sql", function (g, T) {
            ...
            function J(Q, R) {
                ...
                if (V == "'" || (V == '"' && M.doubleQuote)) return (R.tokenize = re(V)), R.tokenize(Q, R);
                if (
                    ((M.nCharCast && (V == "n" || V == "N")) ||
            ...
            return {
                ...
                token: function (Q, R) {
                    ...
                    var x = Q.current();
                    return (
                        x == "(" ? O(Q, R, ")") : x == "[" ? O(Q, R, "]") : R.context && R.context.type == x && D(R), V
                    );
                },
                indent: function (Q, R) {
                    var V = Q.context;
...
var ta = Ke(($u, Ku) => {
    (function (o) {
        ...
        o.defineMode("stylus", function (E) {
            ...
            function je($, B) {
                return $.next(), $.match(/\s*[\"\')]/, !1) ? (B.tokenize = null) : (B.tokenize = Se(")")), [null, "("];
            }
            function Ze($, B, se, De) {
                (this.type = $), (this.indent = B), (this.prev = se), (this.line = De || { firstWord: "", indent: 0 });
            }
            function ke($, B, se, De) {
                return (De = De >= 0 ? De : N), ($.context = new Ze(se, B.indentation() + De, $.context)), se;
            }
            function Je($, B) {
                var se = $.context.indent - N;
                return (B = B || !1), ($.context = $.context.prev), B && ($.context.indent = se), $.context.type;
            }
            function He($, B, se) {
            ...
            function fe($, B) {
                return (Me(B) && ($ == "{" || $ == "]" || $ == "hash" || $ == "qualifier")) || $ == "block-mixin";
            }
            function oe($, B) {
            ...
            return (
                (de.block = function ($, B, se) {
                    if (($ == "comment" && we(B)) || ($ == "," && Me(B)) || $ == "mixin") return ke(se, B, "block", 0);
                    ...
                    if ($ == "word") {
                        ...
                        if (ge == "block-keyword")
                            return (ge = "keyword"), B.current(/(if|unless)/) && !we(B) ? "block" : ke(se, B, "block");
                        if (De == "return") return ke(se, B, "block", 0);
                        if (ge == "variable-2" && B.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)) return ke(se, B, "block");
                    }
                            ...
                            : (B.string.match(/^[a-z][\w-]*\(/i) && Me(B)) ||
                              ...
                              : B.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                                ...
                                : Me(B)
                                  ? ke(se, B, "block")
                                  : ke(se, B, "block", 0);
                    if (($ && $.charAt(0) == "@" && Z(B.current().slice(1)) && (ge = "variable-2"), $ == "word")) {
                        var De = B.current();
                        (ge = te(De)),
                ...
                (de.atBlock = function ($, B, se) {
                    ...
                    return $ == "operator" && /^(not|and|or)$/.test(B.current()) && (ge = "keyword"), se.context.type;
                }),
                ...
                (de.interpolation = function ($, B, se) {
                    return (
                        ...
                        $ == "}"
                            ...
                            : $ == "variable-name"
                              ? ke(se, B, "variableName", 0)
                              : ($ == "word" && ((ge = te(B.current())), ge == "tag" && (ge = "atom")), se.context.type)
                    );
                }),
    ...
    (function (o) {
            ...
            if (q.match(d)) {
                ...
                return S.hasOwnProperty(x)
                    ...
                    : b.hasOwnProperty(x)
                      ? "atom"
                      : v.hasOwnProperty(x)
                        ? (C.hasOwnProperty(x) && (O.prev = "define"), "keyword")
                        : D == "define"
                          ? "def"
                          : "variable";
            }
        ...
        function E(q, O, D) {
            for (var Q = q.length == 1, R, V = !1; (R = O.peek()); )
                if (V) {
                    if ((O.next(), R == "(")) return D.tokenize.push(W()), "string";
                    V = !1;
                } else {
    ...
    (function (o) {
        ...
        o.defineMode("coffeescript", function (p, v) {
            ...
            var S =
                ...
                y = ["for", "while", "loop", "if", "unless", "else", "switch", "try", "catch", "finally", "class"],
                c = [
                    "break",
                    "by",
                    "continue",
            ...
            function W(O, D) {
                ...
                if (O.match(z)) {
                    if (O.current() != "/" || O.match(/^.*\//, !1))
                        return (D.tokenize = E(O.current(), !0, "string-2")), D.tokenize(O, D);
                    O.backUp(1);
                }
            ...
            function J(O, D) {
                if (D.scope.prev)
                    if (D.scope.type === "coffee") {
                        for (var Q = O.indentation(), R = !1, V = D.scope; V; V = V.prev)
                            if (Q === V.offset) {
                                R = !0;
                                break;
                            }
            ...
            var q = {
                ...
                token: function (O, D) {
                    ...
                    return (
                        R &&
                            R != "comment" &&
                            (Q && (Q.align = !0), (D.prop = R == "punctuation" && O.current() == ".")),
                        R
                    );
                },
                indent: function (O, D) {
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function T(U, Z) {
                    if (
                        (U.sol() && ((Z.javaScriptLine = !1), (Z.javaScriptLineExcludesColon = !1)), Z.javaScriptLine)
                    ) {
...
`),
            ...
            if (k === void 0) for (z = s.lineCount(), k = q; k < z && ((y = s.getLineHandle(k)), !v(y)); k++);
            s.operation(function () {
        ...
        for (
            var C = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                ...
                c = function (z, M, w) {
                    ...
                    return (
                        W !== null
                            ? (y(z, W[2]) && (E = ""), (M = W[1] + E + W[3] + M.replace(b, "").replace(g[z], "$1")))
                            : w == !1 && (M = E + " " + M),
                        M
                    );
                },
...
function xc(o, p, v, C) {
    if (!(!o.codemirror || o.isPreviewActive())) {
        ...
        var h = b.getCursor("start"),
            ...
            y = T.slice(0, h.ch),
            c = T.slice(h.ch);
        p == "link" ? (y = y.replace(/(.*)[^!]\[/, "$1")) : p == "image" && (y = y.replace(/(.*)!\[$/, "$1")),
            (c = c.replace(/]\(.*?\)/, "")),
        ...
        Te.prototype.render = function (o) {
            ...
            (C.Enter = "newlineAndIndentContinueMarkdownList"),
                ...
                (this.documentOnKeyDown = function (E) {
                    (E = E || window.event), E.keyCode == 27 && v.codemirror.getOption("fullScreen") && jr(v);
                }),
        ...
        getToolbar: function () {
            ...
            return (
                ...
                ["table", "attachFiles"].some((k) => y.includes(k)) &&
                    ...
                    d.push("|"),
                y.includes("undo") && d.push({ name: "undo", action: EasyMDE.undo, title: T.toolbar_buttons?.undo }),
                y.includes("redo") && d.push({ name: "redo", action: EasyMDE.redo, title: T.toolbar_buttons?.redo }),
                d
            );
        },
    };
