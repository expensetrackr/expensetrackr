					...
					<div className="relative flex flex-col gap-3">
						{logoOrIcon ?? (
							<Link href="/" className="outline-none">
								<img alt="ExpenseTrackr" className="mx-auto w-16 dark:hidden" src="/img/isotype-light.svg" />
								<img alt="ExpenseTrackr" className="mx-auto hidden w-16 dark:block" src="/img/isotype-dark.svg" />
						...
						<div className="flex flex-col gap-3">
							<div className="flex flex-col gap-1">
								{title && <h1 className="text-center font-bold font-inter text-label-lg">{title}</h1>}

								{description && (
									<p className="text-center text-[var(--text-sub-600)] text-paragraph-sm">{description}</p>
								)}
							</div>
						...
						{footer && <p className="pt-1 text-center text-[var(--text-sub-600)] text-label-sm">{footer}</p>}
					</div>
				</div>
			</div>
