...
export function UpdateProfilePictureForm() {
	...
	return (
		...
		>
			<form ref={formRef} className="flex w-full flex-col items-center gap-4 sm:flex-row" onSubmit={updateProfilePhoto}>
				<Field>
							...
							<div className="relative size-40">
								...
								<Dropdown>
									...
									<DropdownMenu className="min-w-32" anchor="bottom end">
										<DropdownItem onClick={() => photoRef.current?.click()} onFocus={() => photoRef.current?.focus()}>
											<ImageEditIcon />
