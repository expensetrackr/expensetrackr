            ...
            <section>
                <div className="container border-x bg-(--bg-white-0) pt-32 pb-12 lg:px-12">
                    <div className="mx-auto max-w-xl">
                        ...
                        <h3 className="mt-8 text-h5 font-bold tracking-tight lg:text-h4">Privacy Policy</h3>
                ...
                <div className="container border-x border-t bg-(--bg-white-0) py-12 lg:px-12">
                    <div
                        ...
                        dangerouslySetInnerHTML={{ __html: purify.sanitize(policy) }}
                    />
                </div>
            </section>
        </>
...
PrivacyPolicy.layout = (page: React.ReactNode & { props: PageProps }) => (
