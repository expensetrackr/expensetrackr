							...
							<div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
									...
									<div className="relative flex items-center gap-6 lg:items-end">
										<div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
											...
											<div className="pt-3 sm:pt-5 lg:pt-0">
												<h2 className="font-semibold text-black text-xl dark:text-white">Documentation</h2>
								...
								>
									...
									<div className="pt-3 sm:pt-5">
										<h2 className="font-semibold text-black text-xl dark:text-white">Laracasts</h2>
								...
								>
									...
									<div className="pt-3 sm:pt-5">
										<h2 className="font-semibold text-black text-xl dark:text-white">Laravel News</h2>
								...
								<div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
									...
									<div className="pt-3 sm:pt-5">
										<h2 className="font-semibold text-black text-xl dark:text-white">Vibrant Ecosystem</h2>

										<p className="mt-4 text-sm/relaxed">
											Laravel's robust library of first-party tools and libraries, such as{" "}
											<a
												href="https://forge.laravel.com"
												className="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20] dark:focus-visible:ring-[#FF2D20] dark:hover:text-white"
											>
												Forge
											</a>
											,{" "}
