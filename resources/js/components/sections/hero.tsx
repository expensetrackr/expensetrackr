...
export function HeroSection() {
    return (
                ...
                <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:items-center lg:px-8 lg:py-40">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
                        ...
                        <p className="mt-4 text-pretty text-(--text-sub-600) lg:text-paragraph-lg">
                            Track expenses, budgets, investments, and assets effortlessly, managing your money
                            confidently.
                        </p>
                        <div className="mt-8 flex flex-col items-center gap-2 lg:flex-row lg:gap-3">
                            <Button.Root asChild className="w-full lg:max-w-36">
                                <Link href={routes.register.url()}>Get started now</Link>
                            </Button.Root>
                            <Button.Root $style="lighter" asChild className="w-full lg:max-w-36">
                    ...
                    <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-4">
                        <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                            <div className="-m-2 rounded-12 bg-(--bg-weak-50) p-2 ring-1 ring-(--stroke-soft-200) ring-inset lg:-m-4 lg:rounded-16 lg:p-4">
                                <Image
                                    alt="App screenshot"
                                    className="w-6xl rounded-6 shadow-2xl ring-1 ring-(--stroke-soft-200)"
                                    height={2106}
        ...
        //     <div className="relative container overflow-hidden border-x border-(--stroke-soft-200) bg-(--bg-white-0) py-32 lg:pb-80">
        //         <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        //             <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
        //                 <h1 className="text-h1 font-semibold tracking-tighter text-pretty">
        //                     Tracking your finances shouldn't be <span className="text-primary">that</span> hard
        //                 </h1>
        ...
        //                     <Button.Root asChild className="w-full lg:w-auto">
        //                         <Link href={routes.register.url()}>Get started now</Link>
        //                     </Button.Root>
        //                     <Button.Root $style="lighter" asChild className="w-full lg:w-auto">
        //                         <Link href="/">Contact sales</Link>
        //                     </Button.Root>
        //                 </div>
        //             </div>
        ...
        //             <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
        //                 <div className="-m-2 rounded-8 bg-(--bg-weak-50) p-2 ring-1 ring-(--stroke-soft-200) ring-inset lg:-m-4 lg:rounded-16 lg:p-4">
        //                     <img
        //                         className="w-[76rem] rounded-8 shadow-2xl ring-1 ring-(--stroke-soft-200)"
        //                         height={1000}
        //                         src="/img/hero-showcase.png"
        //                         width={1000}
        //                     />
