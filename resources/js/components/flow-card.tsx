...
interface FlowCardProps extends React.ComponentProps<"div"> {
    title?: string;
    description?: string;
...
export function FlowCard({ icon, title, description, children, actions, ...props }: FlowCardProps) {
    const Icon = icon;
                    ...
                    <div className="flex w-full flex-col items-center gap-2">
                        ...
                        {title || description ? (
                            <div className="flex flex-col items-center gap-1">
                                ...
                                {description ? (
                                    <Text className="text-center lg:text-paragraph-md">{description}</Text>
                                ) : null}
                            </div>
                        ) : null}
                    </div>
