...
import * as StatusBadge from "./ui/status-badge.tsx";
...
export function VirtualCard({ account, className, ...rest }: CreditCardProps) {
    ...
    return (
        ...
        >
            ...
            <SVGCardBg className="absolute top-0 right-0" />
        </div>
    );
}
