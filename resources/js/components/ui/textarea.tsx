...
type TextareaProps = Omit<React.ComponentPropsWithRef<"textarea">, "children"> & {
    $error?: boolean;
    $simple?: boolean;
...
function TextareaRoot({ containerClassName, children, $error, $simple, ...rest }: TextareaRootProps) {
    if ($simple) {
