...
return [
    'sections' => [
        ...
        'image_and_text' => [
            ...
            'balance_step' => [
                'title' => 'Saldo y moneda',
                'description' => 'Ingresa el saldo y la moneda de tu cuenta. Las opciones disponibles se personalizan según el tipo de cuenta seleccionado.'
            ]
        ],
        'feature' => [
        ...
        'pricing' => [
            ...
            'plans' => [
                ...
                'analyst' => [
                    ...
                    'features' => 'Espacios de trabajo y miembros ilimitados, Cuentas y transacciones ilimitadas, Adjuntos de archivos para transacciones, Categorías predeterminadas y personalizadas, Historial de gráficos personalizado, <strong>Conecta tus cuentas bancarias</strong>, <strong>Importaciones CSV</strong>, <strong>Multi-divisa</strong>',
        ...
        'call_to_action' => [
            'title' => 'Controla tus gastos y aumenta tus ahorros',
